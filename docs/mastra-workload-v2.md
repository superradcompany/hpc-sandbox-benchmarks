...
This mapping supports explicit report comparisons only. Providers' V1 results retain their original identities and are displayed as V1; the existing V1 headline stays in place until a new complete dataset is deliberately published. No V2 measurements are manufactured for other providers. Placement/concurrency differences remain caveats even for compatible tasks.
