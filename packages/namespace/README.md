...
Owns the namespace driver implementation, SDK dependencies, and behavioral tests.
...
Run `bun run --filter @sandbox-benchmarks/namespace test` or `typecheck` from the repo root.
